...
//     avatarGif?: string;       // رابط gif للأفاتار المتحرك
//   usernameColor?: string;   // لون الاسم
//   messageTextColor?: string; // لون نص الرسالة
// };
...
//     item: {
//       type: Schema.Types.ObjectId,
//       ref: "StoreItem", // ⚠️ مهم: لازم يكون نفس اسم موديل المتجر عندك
//       default: null
//     },
